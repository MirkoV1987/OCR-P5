...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark navbar-fixed-top" id="mainNav" style="background-color:#000;">
    ...
    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      <span class="mr-2 d-none d-lg-inline text-white middle">Bonjour, <?= htmlspecialchars(\Framework\Session::getSession()->getKey('user')['username']); ?></span>
      <img class="img-profile rounded-circle img-thumbnail" src="/OCR-P5/Public/img/user/<?= htmlspecialchars(\Framework\Session::getSession()->getKey('user')['imageUrl']); ?>" width="30px" height="auto">
    </a>
  </nav>
