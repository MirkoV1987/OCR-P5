...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark navbar-fixed-top" id="mainNav" style="background-color:#000;">
    ...
    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      <span class="mr-2 d-none d-lg-inline text-white middle">Bonjour, <?= esc_url(\Framework\Session::getSession()->getKey('user')['imageUrl']); ?></span>
        ...
        <div class="card-body">
          <form action="/OCR-P5/post/add" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="file" name="imageUrl" id="fileToUpload" value="<?= isset($post) ? filter_var($post['imageUrl']) : '' ; ?>"> 
