...
<nav class="navbar navbar-expand-md dashboardNav navbar-dark bg-dark navbar-fixed-top  py-3" id="mainNav" style="background-color:#000;">
  ...
  <div>
    <a class="nav-link" href="/OCR-P5/admin/index">
      <span class="mr-2 d-none d-lg-inline text-white">Bonjour, <?= $_SESSION['user']['username']; ?> 
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="row my-6 py-4">
                <div class="col-lg-4">
                  <img class="img-fluid" src="/OCR-P5/Public/img/user/<?= htmlspecialchars($user['imageUrl']); ?>" alt="ImgResponsive" width="260px" height="auto" />
                </div>
              <div class="col-lg-6 py-2">
                <h3 class="section-heading text-regular"><i class="fas fa-user"></i> Pseudo : <?= htmlspecialchars($user['username']); ?></h3>
                <h4 class="section-subheading text-regular"><i class="fas fa-at"></i> Email : <?= htmlspecialchars($user['email']); ?></h4>
                <h4 class="section-subheading text-regular"><i class="far fa-calendar-alt"></i> Date de création : <?= htmlspecialchars($user['date_add_fr']); ?></h4>
              </div>
            </div> 
          </div>
      </div> 
