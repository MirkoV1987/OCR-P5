...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-fixed-top" id="mainNav">
      ...
      <a class="nav-link dropdown-toggle">
        <span class="mr-1 d-none d-lg-inline text-white middle">Bonjour, <?= esc_url(\Framework\Session::getSession()->getKey('user')['username']); ?></span>
  ...
  <!-- Sidebar - Brand -->
    ...
    <!-- End of Sidebar -->
      ...
      <img class="img-fluid my-4 px-2 py-2 " src="/OCR-P5/Public/img/user/<?= esc_url(\Framework\Session::getSession()->getKey('user')['imageUrl']); ?>" alt="user" />
      <!--User add-->
